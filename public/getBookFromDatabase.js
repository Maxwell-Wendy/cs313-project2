...
function getBookFromDatabase (searchText, searchBy, callback) {
    ...
    if (searchText && searchBy == 'title') {
        ...
        sql = "SELECT id, title, author, googleID, isRead, isOwed, isWishList, dateRead FROM book WHERE author = $1::text;";
        params = [searchText];
